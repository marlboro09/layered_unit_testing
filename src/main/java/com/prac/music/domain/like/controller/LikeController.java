...
public class LikeController {
    ...
    @PostMapping("/like")
    public ResponseEntity<String> boardLike(@PathVariable Long boardId, @AuthenticationPrincipal UserDetailsImpl userDetails) {
    ...
    public ResponseEntity<String> commentLike(@PathVariable Long boardId, @PathVariable Long commentId, @AuthenticationPrincipal UserDetailsImpl userDetails) {
